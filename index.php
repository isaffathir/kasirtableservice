                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                           <h1 style="color: cadetblue;">WIKRAMA RESTO</h1>
                        </div>
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label>No Meja</label>
                                    <input class="au-input au-input--full" type="number" name="password" placeholder="Masukkan no meja">
                                </div>
                                ...
                                <br>
                                <button name="btnLogin" class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Pesan Meja</button>
                            </form>
                        </div>
                    </div>
                </div>
